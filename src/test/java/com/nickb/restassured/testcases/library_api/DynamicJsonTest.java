...
public class DynamicJsonTest extends BaseTest {
    ...
    public void addBookTest() {
        ...
        String isbn = LibraryApiTestUtils.generateRandomUuid();
        String aisle = LibraryApiTestUtils.generateRandomUuid();
        ...
        given().log().all().
            ...
            body(LibraryApiTestUtils.addBookPayload("The Sea3", isbn, aisle, "Kim Bartek")).
